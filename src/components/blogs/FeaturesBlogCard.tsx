      ...
      <div className="h-fit bg-zinc-900 rounded-xl overflow-hidden group hover:bg-zinc-800 transition-colors mb-4">
        ...
        <div className="p-8">
          ...
          <p className="text-gray-400 mb-6">
            Learn how to design and implement microservices architecture that can scale to millions of users. We'll cover service discovery, load balancing, and communication
            patterns.
          </p>
