...
import { User, LogOut, Settings, ChevronDown, Settings2 } from "lucide-react";
...
export default function UserMenu() {
  ...
  if (!session) {
    return (
      <div className="flex items-center space-x-3">
        ...
        <Link 
          href="/register" 
          className="gradient-bg text-white px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 transform hover:scale-105"
        >
          Sign Up
        </Link>
      </div>
  ...
  return (
    <div className="relative" ref={userMenuRef}>
      ...
      {/* User Dropdown Menu */}
      {showUserMenu && (
        <div className={`absolute right-0 top-full mt-2 w-56 backdrop-blur-md rounded-xl shadow-2xl overflow-hidden ${
