                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button disabled={submittingModuleId === module.id} onClick={() => submitLessons(module.id)} className="flex items-center space-x-1 px-3 py-1 text-sm bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white rounded transition-colors">
                        <span>{submittingModuleId === module.id ? "Submitting..." : "Submit Lessons"}</span>
                      </button>
                    </div>
                  </div>
