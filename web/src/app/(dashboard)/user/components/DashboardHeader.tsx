 ...
 */
export const DashboardHeader: React.FC<DashboardHeaderProps> = ({ userName, userEmail, avatar }) => (
  <div className="mb-8">
    <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between space-y-6 lg:space-y-0">
      <div className="flex items-center space-x-4">
        <div className="relative">
          <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full flex items-center justify-center shadow-lg">{avatar ? <img src={avatar} alt={userName} className="w-16 h-16 rounded-full object-cover" /> : <User className="w-8 h-8 text-white" />}</div>
